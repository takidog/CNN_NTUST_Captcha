...
for i in range(10):
    # test 10 times.
    # download_captcha('test.png')

    # original = load_img('test.png', color_mode='grayscale')
    original = Image.open('test.png').convert('L')  # convert grayscale

    # w:61 h:14
    original = original.crop((5, 3, 66, 17))
